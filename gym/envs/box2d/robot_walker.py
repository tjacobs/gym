...
# This is a simple 6-joint walker robot environment.
#
...
#
# python gym/envs/box2d/robot_walker.py
#
...
#
# Created by Oleg Klimov, modified by Tom Jacobs. Licensed on the same terms as the rest of OpenAI Gym.
